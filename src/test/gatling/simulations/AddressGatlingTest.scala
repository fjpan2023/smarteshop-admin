...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "country":"SAMPLE_TEXT", "street1":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "stateCode":"SAMPLE_TEXT", "cityName":"SAMPLE_TEXT", "street2":"SAMPLE_TEXT", "zipCode":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))

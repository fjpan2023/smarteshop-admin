...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "smarteshop@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "smarteshop API";

        private String description = "smarteshop API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "smarteshop";

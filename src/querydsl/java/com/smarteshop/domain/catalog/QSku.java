...
public class QSku extends EntityPathBase<Sku> {
    ...
    private static final long serialVersionUID = -1900953971L;
    ...
    public final com.smarteshop.domain.QDimension dimension;
    ...
    public final com.smarteshop.domain.QWeight weight;
    ...
    public QSku(Class<? extends Sku> type, PathMetadata metadata, PathInits inits) {
        ...
        this.dimension = inits.isInitialized("dimension") ? new com.smarteshop.domain.QDimension(forProperty("dimension")) : null;
        this.product = inits.isInitialized("product") ? new QProduct(forProperty("product"), inits.get("product")) : null;
        this.weight = inits.isInitialized("weight") ? new com.smarteshop.domain.QWeight(forProperty("weight")) : null;
    }

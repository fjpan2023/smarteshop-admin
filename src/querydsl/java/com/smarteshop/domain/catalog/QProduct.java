...
public class QProduct extends EntityPathBase<Product> {
    ...
    private static final long serialVersionUID = -1199597985L;
    ...
    public final com.smarteshop.domain.QMerchantStore merchantStore;
    ...
    public QProduct(Class<? extends Product> type, PathMetadata metadata, PathInits inits) {
        ...
        this.merchantStore = inits.isInitialized("merchantStore") ? new com.smarteshop.domain.QMerchantStore(forProperty("merchantStore"), inits.get("merchantStore")) : null;
    }
